<?php require_once 'db_con.php'; 
	...
	if (isset($_POST['register'])) {
		...
		if (empty($username)) {
			$input_error['username'] = "Debe llenar el campo de usuario";
		}
		if (empty($password)) {
			$input_error['password'] = "Debe llenar el campo de contraseña";
		}
		if (empty($photo)) {
			$input_error['photo'] = "Se requiere la fotografía del estudiante";
		}
		...
		if (count($input_error)==0) {
			...
			if (mysqli_num_rows($check_email)==0) {
				...
				$email_error= "El correo ya existe";
			}
...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          ...
          <div class="row animate__animated animate__pulse">
            <div class="col-md-8 offset-md-2">
             	<form method="POST" enctype="multipart/form-data">
				  ...
				  <div class="row">
				  	<div class="col-sm-3"><label for="photo"> Fotografía</label></div>
				  	<div class="col-sm-9">
		  ...
		  <center>
              <p> o <a href="login.php">Ingresar Aquí</a></p></center>
    </div>
