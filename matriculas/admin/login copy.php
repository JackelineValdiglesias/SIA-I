...
if(isset($_SESSION['user_login'])){
	...
	if (isset($_POST['login'])) {
		...
		if (empty($username)) {
			$input_arr['input_user_error']= "El usuario es requerido";
		}

		if (empty($password)) {
			$input_arr['input_pass_error']= "La contraseña es requerida";
		}
		...
		if(count($input_arr)==0){
			...
			if (mysqli_num_rows($result)==1) {
				...
				$usernameerr= "No existe el usuario";
			}
		}
...
<html lang="en">
  ...
  <body>
    <div class="container"><br>
          <h1 class="text-center">Ingreso al Sistema</h1><hr><br>
            ...
            <div class="col-md-4 offset-md-4">
             	<form method="POST" action="">
				  ...
				  <div class="text-center">
					...
					<center>
				    <p>o <a href="register.php">Registrarte acá</a></p></center>
				  </div>
				</form>
            </div>
          </div>
