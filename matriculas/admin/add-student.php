<?php 
  ...
  if (isset($_POST['addstudent'])) {
  	...
  	if (mysqli_query($db_con,$query)) {
  		...
  		$datainsert['inserterror']= '<p style="color: red;">Estudiante no ingresado, revise la información ingresada.</p>';
  	}
  }
?>
...
<div class="col-sm-6">
	...
	<div role="alert" aria-live="assertive" aria-atomic="true" class="toast fade" data-autohide="true" data-animation="true" data-delay="2000">
	  <div class="toast-header">
	    <strong class="mr-auto">Ingreso de Estudiante</strong>
	...
	<form enctype="multipart/form-data" method="POST" action="">
		<div class="form-group">
	  	...
	  	<div class="form-group">
		    ...
		    <input name="pcontact" type="text" class="form-control" id="pcontact" pattern="[0-9]{9}" value="<?= isset($pcontact)? $pcontact: '' ; ?>" placeholder="+51........." required="">
	  	</div>
	  	<div class="form-group">
