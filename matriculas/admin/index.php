...
<body>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    <img src="images/INSIGNIA.png" width="90" height="90" class="d-inline-block align-top" alt=""/>
          <h5><a href="index.php" id="titulo" style="color:white; text-decoration: none; margin:20px;">I.E.P. Esclavas del Sagrado Corazón de Jesús</a> </h5> 
